...
def count_words(training_set):
    ...
    for is_spam, message in training_set_arr:
        if is_spam == 'adult' : 
            ...
            is_spam='2'
        elif is_spam == 'gambling' :
            is_spam='3'
        elif is_spam == 'internet' :
            is_spam='4'
        elif is_spam == 'loan' :
            is_spam='5'
        else :
...
def spam_probability(word_probs, message):
    ...
    for word, prob_if_not_spam, prob_if_adultSpam, prob_if_etcSpam, prob_if_gamblingSpam, prob_if_internetSpam, prob_if_loanSpam in word_probs:
        ...
        if word in message_words:
            ...
            log_prob_if_adultSpam += math.log(10.0 - prob_if_adultSpam)
            log_prob_if_etcSpam += math.log(10.0 - prob_if_etcSpam)
            log_prob_if_gamblingSpam += math.log(10.0 - prob_if_gamblingSpam)
            log_prob_if_internetSpam += math.log(10.0 - prob_if_internetSpam)
            log_prob_if_loanSpam += math.log(10.0 - prob_if_loanSpam)
            log_prob_if_not_spam += math.log(10.0 - prob_if_not_spam)
    ...
    if max_Proba < (prob_if_gamblingSpam / (prob_if_gamblingSpam + prob_if_not_spam)):
        max_Proba = prob_if_gamblingSpam / (prob_if_gamblingSpam + prob_if_not_spam)
...
def nlpKoSpamStart(predicMessage, mode):
    ...
    readData = pd.read_csv('C:/Users/User/Desktop/융합캡스톤디자인/python_bigdata/resource/ocr_result_csv/result.csv', names=['is_spam','message'], encoding='euc-kr')
